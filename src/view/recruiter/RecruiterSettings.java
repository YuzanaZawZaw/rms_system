 ...
 */
public class RecruiterSettings extends javax.swing.JFrame {

	/**
	 * Creates new form RecruiterSettings
	 */
	...
	public RecruiterSettings(String username) {
	...
	private void initComponents() {
		...
		jPanel4Layout.setVerticalGroup(jPanel4Layout.createParallelGroup(
				...
				jPanel4Layout.createSequentialGroup()
						.addGap(0, 12, Short.MAX_VALUE).addComponent(jLabel5)));
		...
		jPanel6Layout.setHorizontalGroup(jPanel6Layout.createParallelGroup(
				...
				jPanel6Layout
						...
						.addComponent(jLabel9,
								javax.swing.GroupLayout.DEFAULT_SIZE, 18,
								Short.MAX_VALUE).addGap(1, 1, 1)));
		jPanel6Layout.setVerticalGroup(jPanel6Layout.createParallelGroup(
				javax.swing.GroupLayout.Alignment.LEADING).addGroup(
				javax.swing.GroupLayout.Alignment.TRAILING,
				jPanel6Layout.createSequentialGroup().addComponent(jLabel9)
		...
		saveButton.setBorder(javax.swing.BorderFactory.createLineBorder(
				new java.awt.Color(153, 102, 255), 3));
		...
		javax.swing.GroupLayout saveButtonLayout = new javax.swing.GroupLayout(
				saveButton);
		saveButton.setLayout(saveButtonLayout);
		saveButtonLayout.setHorizontalGroup(saveButtonLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(
						saveButtonLayout.createSequentialGroup()
		...
		verifyButton.setBorder(javax.swing.BorderFactory.createLineBorder(
				new java.awt.Color(153, 102, 255), 3));
		...
		javax.swing.GroupLayout verifyButtonLayout = new javax.swing.GroupLayout(
				verifyButton);
		verifyButton.setLayout(verifyButtonLayout);
		verifyButtonLayout.setHorizontalGroup(verifyButtonLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(
						verifyButtonLayout.createSequentialGroup()
								.addGap(34, 34, 34).addComponent(jLabel3)
								.addContainerGap(37, Short.MAX_VALUE)));
		verifyButtonLayout.setVerticalGroup(verifyButtonLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(
						javax.swing.GroupLayout.Alignment.TRAILING,
						verifyButtonLayout
	...
	private void ypanelMouseClicked(java.awt.event.MouseEvent evt) {
		// TODO add your handling code here:
		setState(RecruiterSettings.ICONIFIED);
	}
	...
	private void saveButtonMouseClicked(java.awt.event.MouseEvent evt) {
		...
		if (newPassword.equals(confirmPassword)) {
			...
			JOptionPane
					.showMessageDialog(null, "Your passwords didn't matched");
			newPasswordText.setText("");
			confirmPasswordText.setText("");
	...
	private void verifyButtonMouseClicked(java.awt.event.MouseEvent evt) {
		...
		oldPasswordText.setText("");
		if (recruiter.chkRecruiterPass(username, oldPassword)) {
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(
					RecruiterSettings.class.getName()).log(
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				new RecruiterSettings().setVisible(true);
			}
		});
	}
